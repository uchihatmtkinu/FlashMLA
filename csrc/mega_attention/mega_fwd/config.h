...
struct SharedMemoryPlan {
    ...
    transac_bar_t bar_output_smem_empty;
    transac_bar_t bar_output_pack_ready;
};
...
struct barrier_ids {
    ...
    static constexpr int WG01_OUTPUT_SYNC = 4;
    static constexpr int WG1_SYNC = 5;
};
...
static void run(const ArgT& params, int grid_schedule);
