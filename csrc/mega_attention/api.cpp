...
#include "mega_attention/sparse_attention.h"

namespace py = pybind11;

PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.doc() = "Isolated MegaAttention kernels for FlashMLA nv_dev";

    m.def(
        "sparse_prefill_fwd",
        &mega_attention::sparse_prefill_fwd,
        py::arg("q"),
        py::arg("kv"),
        py::arg("indices"),
        py::arg("sm_scale"),
    ...
    m.def(
        ...
        &mega_attention::sparse_decode_ready_fwd,
        py::arg("q"),
        py::arg("kv"),
        py::arg("indices"),
        py::arg("topk_length"),
