...
def _cuda_module():
    ...
    from flash_mla import mega_attention_cuda

    return mega_attention_cuda


def flash_mla_mega_sparse_fwd(
    q: torch.Tensor,
    kv: torch.Tensor,
    ...
    *,
    ...
    if mega and num_sms is None:
        raise ValueError("mega=True requires num_sms")
    ...
    if mega and fused_o_fp8 is not None:
        raise ValueError("mega topology and fused-O are mutually exclusive")
